...
<head>
    ...
    <link rel = "icon" href ="images/aalogo.png" type = "image/x-icon">
    <title>FoodHub</title>
    <!-- Bootstrap core CSS -->
...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/navlogo.png" alt="logo"> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/dish.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Food/Hub </h1>
                    <h5 class="font-white space-xs">Oder Now</h5>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/navlogo.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
                    <div class="col-xs-12 col-sm-2 about color-gray">
                        <h5>About Us</h5>
                        <ul>
                            <li><a href="#">About us</a> </li>
                            <li><a href="https://www.facebook.com/andybalmaceda17" target="_blank">Our Manager</a> </li>
                        </ul>
                    </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address</h5>
                            <p>827X+39W Verdant Square, Macaria Business Center, Governor's Dr, Carmona, 4116 Cavite</p>
                            <h5>Phone: <a href="tel:+09091234567">09091234567</a></h5> </div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Addition informations</h5>
                            <p>thefoodhub2023@gmail.com</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
